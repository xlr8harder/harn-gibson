    ...
    return VisualCatalog(
        primitives=(
            ...
            CatalogEntry(
                "terminal_wall",
                "primitive",
                "Bank of animated terminal panes for command output, stream buffers, traces, and status chatter.",
                (
                    "position",
                    "size",
                    "panels",
                ...
                ("gibson", "cinematic", "motion", "text", "terminal"),
            ),
            CatalogEntry(
                "access_matrix",
                "primitive",
                "Animated access grid for locks, modules, files, sectors, heatmaps, or security status boards.",
                (
                    "position",
                    "size",
                    "rows",
                ...
                ("gibson", "cinematic", "motion", "security", "grid"),
            ),
            CatalogEntry(
                "orbital_map",
                "primitive",
                "Spinning globe/uplink map with nodes, arcs, orbit rings, packets, and scan beams.",
                (
                    "position",
                    "scale",
                    "nodes",
                ...
                ("gibson", "cinematic", "motion", "3d", "map", "network"),
            ),
            CatalogEntry(
                "data_vault",
                "primitive",
            ...
            CatalogEntry(
                ...
                ("generic", "map", "binding", "world-model"),
                {
                    "objectFields": (
                        "id",
                        "entityId",
                    ...
                    "edgeFields": ("source", "target", "label", "tone", "active", "flow"),
                    "targetRef": ("id", "entityId", "path", "label", "index"),
                },
            ),
            CatalogEntry(
                "trace_route",
        ...
        effects=(
            ...
            CatalogEntry(
                "signal_interference",
                "effect",
                "Full-scene CRT noise, jitter bands, dropout blocks, burst lines, and warning labels.",
                (
                    "targetId",
                    "durationMs",
                    "tone",
                ...
                ("gibson", "cinematic", "motion", "timed", "overlay"),
            ),
            CatalogEntry(
                "breach_wave",
                "effect",
