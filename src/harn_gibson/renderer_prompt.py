...
RENDERER_SYSTEM_PROMPT = (
    ...
    "renderInput timeline suggests a sequence. Use breach_wave beats, camera_jolt impacts, camera_path moves, "
    "hologram projections, signal scopes, tunnel grids, trace routes, camera-drifting city_block districts, "
