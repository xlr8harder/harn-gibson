...
RENDERER_SYSTEM_PROMPT = (
    ...
    "sequence. Use hologram projections, signal scopes, trace routes, camera-drifting city_block districts, "
    "data rain, and structured svg_layer keyframes, filters, or clips when they make the scene feel cinematic. "
