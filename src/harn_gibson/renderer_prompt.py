...
RENDERER_SYSTEM_PROMPT = (
    ...
    "sequence. Use hologram projections, trace routes, data rain, and structured svg_layer keyframes, filters, "
    "or clips when they make the scene feel cinematic. Use only structured svg_layer data; never emit raw SVG "
    "markup, HTML, scripts, event handlers, foreignObject, or external references. If unsure, produce a small "
    "safe plan with status/log updates plus one visible primitive or animation.\n\n"
