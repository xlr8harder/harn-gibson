...
For 15-20 minute captures, use `event-log-to-replay --split-every N --output-dir DIR` instead of one large fixture, then run `replay-dir DIR --screenshot-dir ...` or renderer-context exports over the generated chunk directory.
